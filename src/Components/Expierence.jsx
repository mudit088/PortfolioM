...
const Expierence = () => {
  return (
    ...
    <div name= "Experience" className='bg-gradient-to-b from-gray-800 to-black w-full text-white  sm:pt-64 p-10' >
        <div className='max-w-screen-lg py-6 mx-auto flex flex-col justify-center w-full h-full'>
            <div className='pb-8'>
                <p className='text-4xl text-white font-bold inline  border-gray-500'>Experience</p>
            </div>
